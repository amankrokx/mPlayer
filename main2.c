...
void display1(void)
{
    ...
    display_string(180, 350, "RNS Institute of Technology", 1);
    display_string(215, 300, "mPlayer GAME", 1);
...
void disp()
{
    ...
    else
    {
        glLoadIdentity();
        glColor3f(1, 1, 0);
        display_string(150, 450, "mPlayer GAME", 1);
        counting();
        // Drawing of arrow
        glColor3f(0, 1, 1);
        glBegin(GL_LINES);
...
int main(int argc, char **argv)
{
    ...
    glutAddMenuEntry("Aman 1RN20CS016", 9);
    glutAddMenuEntry("Aditya 1RN20CS010", 10);
    glutCreateMenu(game);
